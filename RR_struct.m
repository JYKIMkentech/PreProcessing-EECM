...
%BSL_DataBank V struct 만들기

BSL_DataBank.V{1,1} = [data_ocv(4).SOC, data_ocv(4).V]; %OCV
BSL_DataBank.V{1,2} = [data_rate(2).soc,data_rate(2).V]; 
BSL_DataBank.V{1,3} = [data_rate(6).soc,data_rate(6).V];
BSL_DataBank.V{1,4} = [data_rate(10).soc,data_rate(10).V];
